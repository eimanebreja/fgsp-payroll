        ...
        <div class="container-area">
            ...
            <div class="area-content">
                ...
                <div class="event-body-area">
                    <form action="expenses-edit-query.php" method="POST">
                        <?php
                            $i = 1;
                        ...
                        <div class="event-input">
                            <input type="text" name="ex_check"
                                value="<?php echo $expenses_row['expenses_check_number']; ?>">
                        </div>
                        <div class="event-label">
                            Payable Date :
                        </div>
                        <div class="event-input">
                            <input id="ex_paydate" type="text" name="ex_paydate"
                                value="<?php echo $expenses_row['check_payment_date']; ?>">
                        </div>
                        <div class="event-label">
                            Amount :
                        </div>
